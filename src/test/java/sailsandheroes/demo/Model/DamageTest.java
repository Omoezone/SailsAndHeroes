...
class DamageTest {
    ...
    void criticalShot() {
        Ship attacker = new Ship(1, "William", new Point(1, 1), 160.0, 66, 240, 120.0, 4, "front", "dansk","Grape Shot");
        Ship defender = new Ship(2, "JohnWick", new Point(9, 3), 160.0, 66, 240, 120.0, 4, "front", "dansk","Cannon Ball");
